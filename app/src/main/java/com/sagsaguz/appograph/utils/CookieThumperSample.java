...
public class CookieThumperSample {
    ...
    public static void play(TextSurface textSurface, AssetManager assetManager, String name, Context context) {
        ...
        Text textBraAnies = TextBuilder
                ...
                .setSize(24)
                .setAlpha(0)
                .setColor(context.getResources().getColor(R.color.emerald_green))
                .setPosition(Align.BOTTOM_OF, textDaai).build();

        Text textFokkenGamBra = TextBuilder
                .create(", your best buddy.")
                .setPaint(paint)
                .setSize(24)
                .setAlpha(0)
                .setColor(context.getResources().getColor(R.color.emerald_green))
        ...
        Text texThyLamInnie = TextBuilder
                .create(" I hope you are doing fine")
                .setPaint(paint)
                .setSize(24)
                .setAlpha(0)
                .setColor(context.getResources().getColor(R.color.white))
        ...
        textSurface.play(
                new Sequential(
                        ...
                        new Parallel(TransSurface.toCenter(textDaaiAnies, 500), Slide.showFrom(Side.TOP, textDaaiAnies, 1000)),
